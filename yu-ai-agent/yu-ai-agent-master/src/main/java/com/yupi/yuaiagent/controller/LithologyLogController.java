...
@RestController
@RequestMapping("/data/lithology-log")
public class LithologyLogController {

    private final ILithologyLogService service;

    public LithologyLogController(ILithologyLogService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> add(@RequestBody LithologyLog entity) {
    ...
    public ResponseEntity<Map<String, Object>> getById(@PathVariable("id") Long id) {
        Map<String, Object> res = new HashMap<>();
        LithologyLog data = service.getById(id);
    ...
    @PutMapping
    public ResponseEntity<Map<String, Object>> update(@RequestBody LithologyLog entity) {
        Map<String, Object> res = new HashMap<>();
