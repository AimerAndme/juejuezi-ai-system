...
@RestController
@RequestMapping("/data/coal-seam")
public class CoalSeamController {

    private final ICoalSeamService service;

    public CoalSeamController(ICoalSeamService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> add(@RequestBody CoalSeam entity) {
    ...
    public ResponseEntity<Map<String, Object>> getById(@PathVariable("id") String id) {
        Map<String, Object> res = new HashMap<>();
        CoalSeam data = service.getById(id);
    ...
    @PutMapping
    public ResponseEntity<Map<String, Object>> update(@RequestBody CoalSeam entity) {
        Map<String, Object> res = new HashMap<>();
