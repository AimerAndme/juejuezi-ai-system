...
@RestController
@RequestMapping("/data/mine-area")
public class MineAreaController {

    private final IMineAreaService service;

    public MineAreaController(IMineAreaService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> add(@RequestBody MineArea entity) {
