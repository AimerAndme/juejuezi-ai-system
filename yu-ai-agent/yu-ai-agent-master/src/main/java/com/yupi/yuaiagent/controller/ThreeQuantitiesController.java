...
@RestController
@RequestMapping("/data/three-quantities")
public class ThreeQuantitiesController {

    private final IThreeQuantitiesService service;

    public ThreeQuantitiesController(IThreeQuantitiesService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> add(@RequestBody ThreeQuantities entity) {
    ...
    public ResponseEntity<Map<String, Object>> getById(@PathVariable("id") Long id) {
        Map<String, Object> res = new HashMap<>();
        ThreeQuantities data = service.getById(id);
    ...
    @PutMapping
    public ResponseEntity<Map<String, Object>> update(@RequestBody ThreeQuantities entity) {
        Map<String, Object> res = new HashMap<>();
