...
@RestController
@RequestMapping("/data/monthly-production")
public class MonthlyProductionController {

    private final IMonthlyProductionService service;

    public MonthlyProductionController(IMonthlyProductionService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> add(@RequestBody MonthlyProduction entity) {
    ...
    public ResponseEntity<Map<String, Object>> getById(@PathVariable("id") Long id) {
        Map<String, Object> res = new HashMap<>();
        MonthlyProduction data = service.getById(id);
    ...
    public ResponseEntity<Map<String, Object>> getByBlockId(@PathVariable("blockId") String blockId) {
        Map<String, Object> res = new HashMap<>();
    ...
    @PutMapping
    public ResponseEntity<Map<String, Object>> update(@RequestBody MonthlyProduction entity) {
        Map<String, Object> res = new HashMap<>();
