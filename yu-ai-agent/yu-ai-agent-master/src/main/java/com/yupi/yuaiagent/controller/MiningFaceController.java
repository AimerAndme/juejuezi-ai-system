...
@RestController
@RequestMapping("/data/mining-face")
public class MiningFaceController {

    private final IMiningFaceService service;

    public MiningFaceController(IMiningFaceService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> add(@RequestBody MiningFace entity) {
    ...
    public ResponseEntity<Map<String, Object>> getById(@PathVariable("id") String id) {
        Map<String, Object> res = new HashMap<>();
        MiningFace data = service.getById(id);
    ...
    @PutMapping
    public ResponseEntity<Map<String, Object>> update(@RequestBody MiningFace entity) {
        Map<String, Object> res = new HashMap<>();
