...
@RestController
@RequestMapping("/data/surface-station")
public class SurfaceStationController {

    private final ISurfaceStationService service;

    public SurfaceStationController(ISurfaceStationService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> add(@RequestBody SurfaceStation entity) {
    ...
    public ResponseEntity<Map<String, Object>> getById(@PathVariable("id") String id) {
        Map<String, Object> res = new HashMap<>();
        SurfaceStation data = service.getById(id);
    ...
    @PutMapping
    public ResponseEntity<Map<String, Object>> update(@RequestBody SurfaceStation entity) {
        Map<String, Object> res = new HashMap<>();
