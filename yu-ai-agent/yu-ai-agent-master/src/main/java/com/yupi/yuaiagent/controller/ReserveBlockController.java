...
@RestController
@RequestMapping("/data/reserve-block")
public class ReserveBlockController {

    private final IReserveBlockService service;

    public ReserveBlockController(IReserveBlockService service) {
        this.service = service;
    }

    @PostMapping
    public ResponseEntity<Map<String, Object>> add(@RequestBody ReserveBlock entity) {
    ...
    public ResponseEntity<Map<String, Object>> getById(@PathVariable("id") String id) {
        Map<String, Object> res = new HashMap<>();
        ReserveBlock data = service.getById(id);
    ...
    @PutMapping
    public ResponseEntity<Map<String, Object>> update(@RequestBody ReserveBlock entity) {
        Map<String, Object> res = new HashMap<>();
